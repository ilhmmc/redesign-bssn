  ...
  const stepsPrevention = [
    {
      ...
      description:
        "Pelajari berbagai bentuk cyberbullying seperti pelecehan online, penyebaran rumor, ancaman, dan pengucilan di media sosial.",
      icon: Eye,
      tips: [
    ...
    },
    {
      ...
      description:
        "Hindari membalas dengan kemarahan atau melakukan serangan balik yang dapat memperburuk situasi.",
      icon: MessageSquare,
      tips: [
    ...
    },
    {
      ...
      description:
        "Simpan semua bukti cyberbullying untuk keperluan pelaporan ke pihak berwenang.",
      icon: Lock,
      tips: [
    ...
    },
    {
      ...
      description:
        "Gunakan fitur report dan block yang tersedia di platform media sosial untuk melindungi diri.",
      icon: Shield,
      tips: [
  ...
  const emergencySteps = [
    {
      ...
      description:
        "Segera beritahu orangtua, guru, atau konselor tentang situasi yang dialami.",
      icon: Users,
    },
    {
      title: "Laporkan ke Pihak Berwenang",
      description:
        "Jika cyberbullying melibatkan ancaman serius, segera hubungi polisi atau layanan darurat.",
      icon: Phone,
    },
    {
      title: "Cari Dukungan Psikologis",
      description:
        "Jangan ragu untuk mencari bantuan profesional jika cyberbullying berdampak pada kesehatan mental.",
      icon: Shield,
    },
  ];
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center space-y-6">
                ...
                <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">
                  Cara Mengatasi{" "}
                  <span className="text-red-600">Cyberbullying</span>
                </h1>

                <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                  Panduan lengkap untuk mengidentifikasi, mengatasi, dan
                  mencegah cyberbullying di berbagai platform digital. Lindungi
                  diri dan orang terdekat dari ancaman online.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto flex items-center justify-center space-x-4">
              ...
              <p className="text-center font-semibold">
                ...
                cyberbullying yang serius, segera hubungi nomor darurat atau
                layanan konseling
              </p>
            </div>
          </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  Ikuti panduan ini secara berurutan untuk menangani
                  cyberbullying dengan efektif dan aman
                </p>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground">
                  Jika cyberbullying melibatkan ancaman serius atau berdampak
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-muted-foreground">
                  Langkah-langkah proaktif untuk mencegah menjadi korban
                  cyberbullying
                </p>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center space-y-8">
              ...
              <p className="text-xl text-red-100">
                Cyberbullying adalah masalah serius yang membutuhkan perhatian
                kita bersama. Mari berperan aktif dalam menciptakan lingkungan
