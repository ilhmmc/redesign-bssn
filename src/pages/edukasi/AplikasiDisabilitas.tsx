  ...
  const appCategories = [
      ...
      apps: [
        {
          ...
          desc: "Screen reader built-in untuk navigasi dengan suara",
        },
        {
          name: "VoiceOver (iOS)",
          desc: "Pembaca layar terintegrasi di perangkat Apple",
        },
        { name: "NVDA", desc: "Screen reader gratis untuk komputer Windows" },
        {
          name: "Be My Eyes",
          desc: "Aplikasi yang menghubungkan dengan volunteer untuk bantuan visual",
        },
      ],
    },
    {
      ...
      apps: [
        {
          name: "Live Caption",
          desc: "Subtitle real-time untuk video dan audio",
        },
        {
          name: "Sound Amplifier",
          desc: "Penguat suara untuk pendengaran yang lebih baik",
        },
    ...
    },
    {
      ...
      apps: [
        {
          name: "Proloquo2Go",
          desc: "Aplikasi komunikasi untuk yang kesulitan berbicara",
        },
        {
          name: "CogniFit",
          desc: "Latihan kognitif untuk meningkatkan daya ingat",
        },
        {
          name: "Google Assistant",
          desc: "Asisten suara untuk membantu aktivitas sehari-hari",
        },
        {
          name: "Todoist",
          desc: "Pengingat tugas dengan interface yang sederhana",
        },
      ],
    },
    {
      ...
      apps: [
        {
          name: "Switch Access",
          desc: "Kontrol perangkat dengan switch eksternal",
        },
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center space-y-6">
                ...
                <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">
                  <span className="text-blue-600">Aplikasi Bantu</span>{" "}
                  Penyandang Disabilitas
                </h1>
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                  Kumpulan aplikasi dan tools digital yang dapat membantu
                  penyandang disabilitas dalam aktivitas sehari-hari.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl font-bold mb-4">
                  Aplikasi Berdasarkan Jenis Disabilitas
                </h2>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center space-y-8">
              ...
              <p className="text-xl text-blue-100">
                Dengan aplikasi dan tools yang tepat, teknologi dapat menjadi
                jembatan untuk kehidupan yang lebih mandiri dan produktif.
              </p>
              <Button
                variant="secondary"
                size="lg"
