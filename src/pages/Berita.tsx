...
const Berita = () => {
  ...
  const featuredNews = {
    ...
    date: "2025-07-22",
    author: "Biro Hukum dan Komunikasi Publik BSSN",
  ...
  const newsArticles = [
    ...
    },
    {
      ...
      content: "Jakarta, BSSN.go.id – Badan Siber dan Sandi Negara (BSSN) melalui Direktorat Keamanan Siber dan Sandi Energi dan Sumber Daya Alam, Deputi Bidang Keamanan Siber dan Sandi Perekonomian BSSN menyelenggarakan Forum Kolaborasi Perlindungan Infrastruktur Informasi Vital Sektor ESDA Tahun 2025 di Jakarta selama 3 hari pada tanggal 15-17 Juli 2025. Forum ini dihadiri oleh perwakilan dari berbagai perusahaan energi, pertambangan, dan sumber daya alam di Indonesia. Tujuan forum adalah untuk meningkatkan sinergi dan kolaborasi dalam melindungi infrastruktur informasi vital di sektor ESDA dari ancaman siber. Kepala BSSN menegaskan bahwa sektor ESDA merupakan tulang punggung perekonomian nasional yang harus dilindungi dari serangan siber yang dapat mengancam ketahanan energi dan ekonomi nasional. Dalam forum tersebut, BSSN memperkenalkan berbagai mekanisme pelaporan insiden siber, protokol respons darurat, dan standar keamanan siber yang harus diterapkan oleh penyelenggara IIV sektor ESDA. Para peserta juga mendapatkan pelatihan mengenai penanganan insiden siber dan implementasi sistem manajemen keamanan informasi.",
      category: "Info Terkini",
      date: "2025-07-18",
      author: "Tim Humas BSSN",
