            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center space-y-6 mb-12">
                ...
                <h1 className="text-4xl font-bold tracking-tight">
                  Tata Cara{" "}
                  <span className="gradient-text">Permohonan Informasi</span>
                </h1>
                <p className="text-xl text-muted-foreground">
                  Prosedur mengajukan permohonan informasi publik di BSSN
                </p>
              </div>
              <Card>
                <CardHeader>
                  <div className="flex items-center space-x-3">
                    <div className="w-12 h-12 rounded-lg bg-government-100 flex items-center justify-center">
                      <ClipboardList className="h-6 w-6 text-government-600" />
                    </div>
                ...
                <CardContent>
                  <div className="prose prose-lg max-w-none">
                    <p className="text-muted-foreground">
                      Halaman ini akan menampilkan tata cara permohonan
                      informasi lengkap dari Pejabat Pengelola Informasi dan
                      Dokumentasi BSSN. Konten sedang dalam tahap pengembangan.
                    </p>
                  </div>
                </CardContent>
              </Card>
